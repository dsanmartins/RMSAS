...
public class CodeAdapterFactory extends AdapterFactoryImpl {
	...
	protected CodeSwitch<Adapter> modelSwitch =
		new CodeSwitch<Adapter>() {
			...
			@Override
			public Adapter caseModule(kdm.code.Module object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link kdm.code.SynonymUnit <em>Synonym Unit</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link kdm.code.Namespace <em>Namespace</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
