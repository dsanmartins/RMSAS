 ...
 * </p>
 * <ul>
 *   <li>{@link kdm.event.impl.EventImpl#getSource <em>Source</em>}</li>
 *   <li>{@link kdm.event.impl.EventImpl#getEventRelation <em>Event Relation</em>}</li>
 *   <li>{@link kdm.event.impl.EventImpl#getAbstraction <em>Abstraction</em>}</li>
 *   <li>{@link kdm.event.impl.EventImpl#getImplementation <em>Implementation</em>}</li>
 *   <li>{@link kdm.event.impl.EventImpl#getKind <em>Kind</em>}</li>
 * </ul>
 *
 * @generated
 */
