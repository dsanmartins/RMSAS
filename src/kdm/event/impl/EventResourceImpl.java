 ...
 * </p>
 * <ul>
 *   <li>{@link kdm.event.impl.EventResourceImpl#getSource <em>Source</em>}</li>
 *   <li>{@link kdm.event.impl.EventResourceImpl#getEventRelation <em>Event Relation</em>}</li>
 *   <li>{@link kdm.event.impl.EventResourceImpl#getAbstraction <em>Abstraction</em>}</li>
 *   <li>{@link kdm.event.impl.EventResourceImpl#getImplementation <em>Implementation</em>}</li>
 *   <li>{@link kdm.event.impl.EventResourceImpl#getEventElement <em>Event Element</em>}</li>
 * </ul>
 *
 * @generated
 */
