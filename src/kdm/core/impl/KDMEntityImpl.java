 ...
 * </p>
 * <ul>
 *   <li>{@link kdm.core.impl.KDMEntityImpl#getName <em>Name</em>}</li>
 *   <li>{@link kdm.core.impl.KDMEntityImpl#getModel <em>Model</em>}</li>
 *   <li>{@link kdm.core.impl.KDMEntityImpl#getOwner <em>Owner</em>}</li>
 *   <li>{@link kdm.core.impl.KDMEntityImpl#getOwnedElement <em>Owned Element</em>}</li>
 *   <li>{@link kdm.core.impl.KDMEntityImpl#getOutbound <em>Outbound</em>}</li>
 *   <li>{@link kdm.core.impl.KDMEntityImpl#getInbound <em>Inbound</em>}</li>
 *   <li>{@link kdm.core.impl.KDMEntityImpl#getOwnedRelation <em>Owned Relation</em>}</li>
 *   <li>{@link kdm.core.impl.KDMEntityImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link kdm.core.impl.KDMEntityImpl#getGroupedElement <em>Grouped Element</em>}</li>
 *   <li>{@link kdm.core.impl.KDMEntityImpl#getInAggregated <em>In Aggregated</em>}</li>
 *   <li>{@link kdm.core.impl.KDMEntityImpl#getOutAggregated <em>Out Aggregated</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class KDMEntityImpl extends ModelElementImpl implements KDMEntity {
	...
	public KDMEntity getOwner() {
		...
		return (KDMEntity)eInternalContainer();
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case CorePackage.KDM_ENTITY___CREATE_AGGREGATION__KDMENTITY:
				return createAggregation((KDMEntity)arguments.get(0));
			case CorePackage.KDM_ENTITY___DELETE_AGGREGATION__AGGREGATEDRELATIONSHIP:
				deleteAggregation((AggregatedRelationship)arguments.get(0));
				return null;
		}
