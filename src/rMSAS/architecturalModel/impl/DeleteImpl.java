 ...
 * @generated
 */
public class DeleteImpl extends AbstractArchitecturalOperationImpl implements Delete {
	/**
	...
	protected EClass eStaticClass() {
		return ArchitecturalModelPackage.Literals.DELETE;
	}
		...
		if (from != null && from.eIsProxy()) {
			...
			if (from != oldFrom) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ArchitecturalModelPackage.DELETE__FROM, oldFrom, from));
			}
		}
		return from;
	}
	...
	public void setFrom(AbstractStructureElement newFrom) {
		...
		from = newFrom;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArchitecturalModelPackage.DELETE__FROM, oldFrom, from));
	}
